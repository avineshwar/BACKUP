...
#         echo hello
# fi
## FOR DEALING WITH VERBOSE
# EITHER REFACTOR (AND FUNCTIONISE), OR BISECT THE CODE INTO TWO BRANCHES.
# TO STAY HELPFULLY VERBOSE, WE CAN INCLUDE VARIABLES IN COMMAND EXECUTIONS WHOSE VALUES WILL BE SET TO SOMETHING (COMMAND SPECIFIC)
# SO THAT THOSE COMMANDS CAN BECOME VERBOSE. AS AN EXAMPLE: "tar zcf$v" CAN BE "tar zcfv" FOR VERBOSE AND "tar zcf" FOR QUIET.
# THIS SHALL BE SET FROM THE VERBOSE FUNCTION. JUST TAKE CARE WHILE USING VARIABLES (VARIABLE CLASHES SHOULDN'T ARISE).
